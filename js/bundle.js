...
function slider(_ref) {
  var prevSelector = _ref.prevSelector,
      nextSelector = _ref.nextSelector,
      sliderItemSelector = _ref.sliderItemSelector,
      slidesWrapperSelector = _ref.slidesWrapperSelector,
      slidesFieldSelector = _ref.slidesFieldSelector,
      slidesToShow = _ref.slidesToShow;
  var arrowPrev = document.querySelector(prevSelector),
  ...
  slidesField = document.querySelector(slidesFieldSelector),
      // полоса со всеми слайдами
  slidesShownWidth = window.getComputedStyle(slidesWrapper).width,
      // ширина видимой части со слайдами для показа
...
function tabs() {
  //Tabs
  var tabsParent = document.querySelector('.catalog-body__headings'),
